...
namespace HexAdapt{
    template<template<class, class> class TContainer, class TObject = Cell, class TAllocator = std::allocator<TObject> >
    class HexAdapter : public AbstractHex{
        public:
            ...
            HexAdapter();
            HexAdapter(const int& s);
            HexAdapter(const int& s, const int& gm);
        private:
            TContainer<TContainer<TObject, TAllocator>, std::allocator<TContainer<TObject, TAllocator> > > hexCells;
    };
    /*prints the current board*/
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    void HexAdapter<TContainer, TObject, TAllocator>::print(){
        cout << endl <<  "  ";
    ...
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    void HexAdapter<TContainer, TObject, TAllocator>::readFromFile(int& player_turn, const std::string& filename){
        ifstream fin;
        string s;
        fin.open(filename);
        if(fin){
    ...
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    void HexAdapter<TContainer, TObject, TAllocator>::writeToFile(const int& player_turn, const std::string& filename) const{
        ofstream fout;
        fout.open(filename);
        if(fout){
    ...
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    void HexAdapter<TContainer, TObject, TAllocator>::reset(){
        for(int i = 0; i < getSize(); i++){
            for(int j = 0; j < getSize(); j++){
    ...
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    void HexAdapter<TContainer, TObject, TAllocator>::setSize(const int& size){
        boardSize = size;
    ...
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    void HexAdapter<TContainer, TObject, TAllocator>::play(const Cell& coordinates){
    ...
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    void HexAdapter<TContainer, TObject, TAllocator>::play(){
    ...
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    void HexAdapter<TContainer, TObject, TAllocator>::playGame(){
        Cell temp;
        string input;
    ...
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    Cell HexAdapter<TContainer, TObject, TAllocator>::operator()(const int& x, const int& y){
    ...
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    bool HexAdapter<TContainer, TObject, TAllocator>::isWinner_P1(const int& x, const int& y, int rotation){
    ...
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    bool HexAdapter<TContainer, TObject, TAllocator>::isWinner_P2(const int& x, const int& y, int rotation){
    ...
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    bool HexAdapter<TContainer, TObject, TAllocator>::check_cell_state(const int& x, const char& y) const{
    ...
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    bool HexAdapter<TContainer, TObject, TAllocator>::isConnected(const cell_state& player){
    ...
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    void HexAdapter<TContainer, TObject, TAllocator>::find_beginning(const cell_state& player){
        if(player == Player1){
    ...
    /*constructor*/
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    HexAdapter<TContainer, TObject, TAllocator>::HexAdapter() : AbstractHex(){
        setSize(5);
    }
    /*constructor with size argument*/
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    HexAdapter<TContainer, TObject, TAllocator>::HexAdapter(const int & s) : AbstractHex(s){
        setSize(s);
    }
    /*constructor with size and gamestatus arguments*/
    template<template<class, class> class TContainer, class TObject, class TAllocator>
    HexAdapter<TContainer, TObject, TAllocator>::HexAdapter(const int& s, const int& gm) : AbstractHex(s, gm){
        setSize(s);
    }
}
#endif